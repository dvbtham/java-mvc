...
public class baihatFrame extends JFrame {
	...
	public void initGUI() {
		...
		defaultModel.addElement(constants.MUST_PICK);
		try {
		...
		cbbAlbum.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				tenAlbum = (String) cbbAlbum.getSelectedItem();
				//JOptionPane.showMessageDialog(null, tenAlbum);
				try {
	...
	public boolean validForm() {
		...
		if (maalbum == "" || tenAlbum.equals(constants.MUST_PICK) || tenAlbum == "")  {
